...
const RU: Record<string, string> = {
  ...
  // event fields (status / busy / visibility / color / attendees)
  "End date": "Дата окончания",
  "Confirmed": "Подтверждено",
  "Tentative": "Предварительно",
  "Cancelled": "Отменено",
  "Shows as": "Показывать как",
  "Busy": "Занят",
  "Free": "Свободен",
  ...
  "comma separated": "через запятую",
  "Attendees": "Участники",
  "Add attendee": "Добавить участника",
  "email": "эл. почта",
  "Name": "Имя",
  "Accepted": "Принято",
  "Declined": "Отклонено",
  "Needs action": "Нет ответа",
  "Delegated": "Делегировано",
  "e.g. 15m, 1h, end-5m, @2026-09-20T09:00 — empty for none":
    "напр. 15m, 1h, end-5m, @2026-09-20T09:00 — пусто, если не нужно",
  "Reminders must be offsets like 15m, 1h, end-5m, @2026-09-20T09:00":
    "Напоминания: 15m, 1h, end-5m или @2026-09-20T09:00",
};
